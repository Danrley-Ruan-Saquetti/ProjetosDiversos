...
public class Jogador implements Serializable {
    ...
    @GeneratedValue
    private int id;
    private final String nome, senha;
    ...
    public void atualizarSaldo(double valor) {
        ...
        if (getSaldo() > 99999999.99) {
            ...
            System.out.println("SISTEMA: Parece que você zerou seu saldo. Tome R$10,00 de incentivo!");
            setSaldo(10);
        }
        setTotalJogos(getTotalJogos() + 1);
        atualizarVB_DB();
        atualizarVC_DC();
        atualizarVG_DG();
        atualizarVP_DP();
    ...
    public String instrucao() {
        return "+-\n|- ROLETA\n"
                + "|Aposte um valor e escolha um número de 0 até 38. Se o número sorteado for "
                + "aquele que você escolheu, poderá ganhar 5 vezes o valor apostado, porém, as"
                + " chances \n|são de 2%!\n|\n|- CAÇA NÍQUEIS\n|Para ganhar dinheiro no Caça N"
                + "íqueis, deverá pagar uma entrada de R$5,00 para rodá-lo. Após pagar a entra"
                + "da, rode o níquel e faça um combo de sequência do \n|mesmo valor. \n|Os prê"
                + "mios são: para cada par, ganha-se R$15,00; para cada trinca, ganha-se R$25,"
                + "00; uma quadra, ganha-se R$30,00; e um perfeito (quíntupla), ganha-se \n|R$"
                + "50,00.\n|\n|- BINGO\n|O clássico Bingo! Para jogá-lo, deve-se fazer a inscr"
                + "ição de R$50,00. Você irá competir contra 20 jogadores.\n|Risque os valores"
                + " da cartela que foram sorteados e esteja entre os primeiros a completar a c"
                + "artela para ganhar o prêmio.\n|Os prêmios são: 1º lugar - R$250,00; 2º luga"
                + "r: R$200,00; 3º lugar - R$150,00; 4º lugar: R$100,00.\n+-";
    }
